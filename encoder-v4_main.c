...
static uint32_t next_tick_ms = 0;             // scheduler for 200 Hz (5 ms)
/* USER CODE END PV */
...
int main(void)
{
  ...
  next_tick_ms = HAL_GetTick() + 5;  // 200 Hz = every 5 ms

  // Header line for CSV
  printUART("count,delta_5ms\r\n");
  /* USER CODE END 2 */
